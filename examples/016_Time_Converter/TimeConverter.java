 ...
 * public static variables, indicating that the values won't change. TimeConverter
...
public class TimeConverter {
	...
	// Double method for to convert minutes to seconds
	public static double minutesToSeconds( double minutes ) {
		return SECONDS_IN_MINUTE * minutes;
	}
	// Double method for to convert hours to minutes
    public static double hoursToMinutes( double hours ) {
		return MINUTES_IN_HOURS * hours;
	}
	// Double method for to convert days to hours
